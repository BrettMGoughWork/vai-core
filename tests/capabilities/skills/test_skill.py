"""
Tests for CapabilitySkill dataclass (Phase 3.3.3).
...
class FakePrimitive(PrimitiveBase):
    """Minimal concrete primitive for CapabilitySkill testing."""
...
class TestFromManifest:
    """Tests for CapabilitySkill.from_manifest."""

    def test_valid_manifest_with_registry_succeeds(self):
        """A valid manifest with a pre-populated registry produces a CapabilitySkill."""
        manifest = make_manifest()
        registry = make_registry("file.read")
        skill = CapabilitySkill.from_manifest(manifest, registry)
...
class TestValidateInputs:
    """Tests for CapabilitySkill.validate_inputs."""
...
class TestValidateOutputs:
    """Tests for CapabilitySkill.validate_outputs."""
    ...
    def test_missing_required_output_raises(self):
        ...
        skill = CapabilitySkill(manifest=m, primitives={"file.read": reg.get("file.read")},
