...
@patch("src.core.agent.core_step_executor.call_with_retry")
...
def test_core_step_executor_records_success_on_tool_execution(mock_call_with_retry, mock_all_specs_for_agent):
    ...
    with patch("src.core.agent.core_step_executor.select_tool") as mock_select_tool, \
         patch("src.core.agent.core_step_executor.execute_with_retry") as mock_execute:
        spec = MagicMock()
        spec.name = "echo"
...
@patch("src.core.agent.core_step_executor.classify_step")
@patch("src.core.agent.core_step_executor.SkillRegistry.all_specs_for_agent")
@patch("src.core.agent.core_step_executor.call_with_retry")
