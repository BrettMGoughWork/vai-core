...
def test_core_step_executor_records_success_on_tool_execution(mock_call_with_retry, mock_all_specs_for_agent):
    ...
    with patch("src.core.agent.corestep.select_tool") as mock_select_tool, \
         patch("src.core.agent.corestep.execute_with_retry") as mock_execute:
        spec = MagicMock()
        spec.name = "echo"
...
@patch("src.core.agent.corestep.classify_step")
@patch("src.core.agent.corestep.SkillRegistry.all_specs_for_agent")
@patch("src.core.agent.corestep.call_with_retry")
