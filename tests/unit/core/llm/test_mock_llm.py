"""Tests for src.core.llm.mock_llm — MockLLM determinism and ChatProvider compliance."""
...
from src.core.llm.mock_llm import MockLLM, MOCK_PLAN_RESPONSE, _HALLUCINATION_RESPONSE
...
class TestMockLLMChatProviderProtocol:
    ...
    def test_registered_in_llm_factory(self):
        from src.core.llm.llm_factory import PROVIDER_CLIENTS
