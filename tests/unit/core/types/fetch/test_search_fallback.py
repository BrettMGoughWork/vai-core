...
from src.core.types.fetch.errors import FetchError, TimeoutError
from src.core.types.fetch.fallback_router import select_fallback
...
from src.core.types.fetch.taxonomy import classify_url, choose_fetch_mode
...
class TestSearchFallbackCallsSearchUrls:
    ...
    def test_search_fallback_calls_search_primitive(self):
        ...
        with patch.object(primitive, "_execute_search", return_value=[
            ...
            from src.core.state.config import SearchConfig
