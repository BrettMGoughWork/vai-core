"""Tests for stdlib.http.simple primitive (Phase 3.10.2)."""
...
@pytest.fixture
def fetch() -> HttpSimpleFetchPrimitive:
    """Real HttpSimpleFetchPrimitive instance."""
    return HttpSimpleFetchPrimitive()
...
class TestHttpFetchValidate:
    """Tests for HttpSimpleFetchPrimitive.validate_args."""

    def test_valid_minimal_args(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Just a URL passes validation."""
        fetch.validate_args({"url": "https://example.com"})

    def test_valid_with_all_args(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_valid_timeout_as_int(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Integer timeout is valid."""
        fetch.validate_args({"url": "https://example.com", "timeout": 5})

    def test_missing_url_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Missing 'url' key raises ValueError."""
        with pytest.raises(ValueError, match="must contain 'url' key"):
            fetch.validate_args({})

    def test_non_string_url_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Non-string url raises ValueError."""
        with pytest.raises(ValueError, match="'url' must be a string"):
            fetch.validate_args({"url": 42})

    def test_empty_url_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Empty url raises ValueError."""
        with pytest.raises(ValueError, match="'url' must not be empty"):
            fetch.validate_args({"url": ""})

    def test_non_number_timeout_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_negative_timeout_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Non-positive timeout raises ValueError."""
        with pytest.raises(ValueError, match="'timeout' must be positive"):
            fetch.validate_args({"url": "https://x.com", "timeout": -1})

    def test_zero_timeout_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
        """Zero timeout raises ValueError."""
        with pytest.raises(ValueError, match="'timeout' must be positive"):
            fetch.validate_args({"url": "https://x.com", "timeout": 0})

    def test_non_dict_headers_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_header_non_string_key_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_header_non_string_value_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_args_not_a_dict_raises(self, fetch: HttpSimpleFetchPrimitive) -> None:
...
class TestHttpFetchExecuteSuccess:
    """Tests for HttpSimpleFetchPrimitive.execute — successful responses."""

    def test_successful_get(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_custom_headers_forwarded(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_timeout_forwarded(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_timeout_not_forwarded_when_omitted(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_404_returns_success_with_status(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_500_returns_success_with_status(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_elapsed_ms_is_positive(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_no_side_effects(self, fetch: HttpSimpleFetchPrimitive) -> None:
...
class TestHttpFetchExecuteErrors:
    """Tests for HttpSimpleFetchPrimitive.execute — transport failures."""

    def test_timeout_error(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_connection_error(self, fetch: HttpSimpleFetchPrimitive) -> None:
    ...
    def test_invalid_url(self, fetch: HttpSimpleFetchPrimitive) -> None:
...
class TestHttpFetchContext:
    ...
    def test_context_ignored(self, fetch: HttpSimpleFetchPrimitive) -> None:
