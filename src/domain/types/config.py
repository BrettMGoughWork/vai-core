"""
Domain-level configuration dataclasses for cross-stratum use.

Types defined here are used by multiple strata and are thus housed in
the domain stratum which is importable by all.
"""
