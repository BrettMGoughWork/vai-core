...
It lives in the domain layer so that all strata can depend on it
...
from src.domain.types.capabilities import SkillCategory, SideEffect
...
class ToolSpec:
    ...
    # Is this capability pure from infrastructure's perspective?
    pure: bool = True
