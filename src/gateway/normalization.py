"""Gateway normalization — converts external inputs to canonical ChannelMessage format.
...
inbound message format for the Platform.
"""
...
class ChannelMessage(BaseModel):
    """Canonical inbound message format for the Platform.
