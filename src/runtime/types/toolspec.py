"""
Canonical ToolSpec contract shared across all strata.

ToolSpec is the canonical description of a tool exposed to the LLM.
It lives in the runtime (S1) so that all strata can depend on it
...
from src.runtime.types.capabilities import SkillCategory, SideEffect
