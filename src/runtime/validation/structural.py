"""
Structural validation helpers for JSON-like schemas.

Canonical home for validate_structural, used by both
S2 (strategy) and S3 (capabilities) to avoid circular
dependencies.
"""
...
from src.runtime.types.errors import ValidationError
