"""
Runtime Stratum — LLM Backend Contract (S1 Contract)
=====================================================

Owned by the Runtime stratum.  Explicit, typed boundary types for
S2↔S1 communication.  All types are pure dataclasses with JSON-safe
fields.
