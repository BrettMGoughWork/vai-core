...
from src.agent.memory.governance.governance_errors import GovernanceViolation
from src.agent.memory.governance.normalisation import try_normalise_iso_timestamp
...
def is_subgoal_write_allowed(
    ...
    from src.agent.memory.types.transition_engine import TransitionEngine
    from src.agent.memory.types.transitions import LifecycleTransitionEngine
