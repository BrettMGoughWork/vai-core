"""stdlib.file.delete — Delete a file or empty directory (Phase 3.18.1)."""
...
class FileDeletePrimitive(PrimitiveBase):
    """Delete a file at the given path (or empty directory via os.rmdir)."""
