"""stdlib.csv.read — Read a CSV file into a list of rows (Phase 3.18.2)."""
...
class CsvReadPrimitive(PrimitiveBase):
    ...
    def execute(self, args: dict, context: dict) -> PrimitiveResult:
        ...
        return PrimitiveResult(status="success", data={"rows": rows})
