...
from src.core.memory.governance.normalisation import try_normalise_iso_timestamp
...
def is_subgoal_write_allowed(
    ...
    from src.core.planning.subgoals.transition_engine import TransitionEngine
    from src.core.planning.subgoals.transitions import LifecycleTransitionEngine
